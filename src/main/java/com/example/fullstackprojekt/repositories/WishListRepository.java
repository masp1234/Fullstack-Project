...
public class WishListRepository {
    ...
    public List<WishList> findByUserId(int id) {
        ...
        final String FIND_QUERY = "SELECT * FROM wish_list1  WHERE user_id=?";
        try {
    ...
    public WishList findWishListById(int id){
        final String FIND_QUERY="SELECT * FROM wish_list1  WHERE wish_list_id=?";
    ...
    public void updateByid(WishList wishList) {
        ...
        final String UPDATE_QUERY="UPDATE wish_list1 SET wish_list_name=?, wish_list_description=? WHERE wish_list_id=?";
        try {
    ...
    public void deleteById(int id){
        final String DELETE_QUERY="DELETE FROM wishList1 WHERE wish_list_id=?";
        try {
